...
**710 live proxies** · 80 countries · updated **2026-08-31 20:56 UTC**
...
| File | Count | Format |
|---|---|---|
| [`proxies/all.txt`](proxies/all.txt) | 710 | `protocol://ip:port` |
...
| [`proxies/all.json`](proxies/all.json) | 710 | country, anonymity, latency, uptime, score |

Top countries: China (95) · Netherlands (90) · United States (64) · Indonesia (44) · Germany (41) · Russia (37) · Hong Kong SAR China (18) · India (18) · Brazil (17) · Singapore (16)
...
| [proxifly/free-proxy-list](https://github.com/proxifly/free-proxy-list) | 104 |
