...
**1288 live proxies** · 100 countries · updated **2026-09-14 04:56 UTC**
...
| File | Count | Format |
|---|---|---|
| [`proxies/all.txt`](proxies/all.txt) | 1288 | `protocol://ip:port` |
...
| [`proxies/socks5.txt`](proxies/socks5.txt) | 388 | `ip:port` |
| [`proxies/elite.txt`](proxies/elite.txt) | 992 | `protocol://ip:port`, no leak found |
| [`proxies/all.json`](proxies/all.json) | 1288 | country, anonymity, latency, uptime, score |

Top countries: United States (165) · Indonesia (114) · Russia (75) · China (68) · India (65) · Vietnam (64) · Brazil (63) · Netherlands (50) · France (48) · Bangladesh (42)
